...
// gap the app hits is Element.prototype.replaceChildren (Chrome 86 / Safari 14,
// 2020), used by main.ts to fill the upcoming-phases list. Everything else the
// app needs (Intl.DateTimeFormat, URLSearchParams) already exists at the floor,
